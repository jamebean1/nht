$PBExportHeader$u_criteria_searchappeals.sru
$PBExportComments$This is the criteria for the search deals canvas
forward
global type u_criteria_searchappeals from u_criteria_search
end type
type cbx_1 from checkbox within u_criteria_searchappeals
end type
type r_bullet1 from rectangle within u_criteria_searchappeals
end type
type r_bullet2 from rectangle within u_criteria_searchappeals
end type
type r_bullet3 from rectangle within u_criteria_searchappeals
end type
type r_bullet4 from rectangle within u_criteria_searchappeals
end type
end forward
...
global u_criteria_searchappeals u_criteria_searchappeals
...
on u_criteria_searchappeals.create
int iCurrent
call super::create
...
on u_criteria_searchappeals.destroy
call super::destroy
destroy(this.cbx_1)
...
type sle_customtitle from u_criteria_search`sle_customtitle within u_criteria_searchappeals
integer taborder = 20
end type

type dw_dynamic_criteria from u_criteria_search`dw_dynamic_criteria within u_criteria_searchappeals
end type

type st_criteria_dynamic from u_criteria_search`st_criteria_dynamic within u_criteria_searchappeals
end type

type st_criteria_basic from u_criteria_search`st_criteria_basic within u_criteria_searchappeals
end type

type st_tab_filler from u_criteria_search`st_tab_filler within u_criteria_searchappeals
end type

type dw_report_criteria from u_criteria_search`dw_report_criteria within u_criteria_searchappeals
integer width = 3278
integer height = 504
integer taborder = 10
string dataobject = "d_criteria_search_appeals"
end type

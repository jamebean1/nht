$PBExportHeader$u_ddplb_search.sru
$PBExportComments$Picture drop down list box search class
forward
global type u_ddplb_search from dropdownpicturelistbox
end type
end forward
...
global u_ddplb_search u_ddplb_search

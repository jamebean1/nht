$PBExportHeader$u_plb_filter.sru
$PBExportComments$Picture list box filter class
forward
global type u_plb_filter from picturelistbox
end type
end forward
...
global u_plb_filter u_plb_filter

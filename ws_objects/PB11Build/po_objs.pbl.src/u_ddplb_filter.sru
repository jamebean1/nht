$PBExportHeader$u_ddplb_filter.sru
$PBExportComments$Picture drop down list box filter class
forward
global type u_ddplb_filter from dropdownpicturelistbox
end type
end forward
...
global u_ddplb_filter u_ddplb_filter

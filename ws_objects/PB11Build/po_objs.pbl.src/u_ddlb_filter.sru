$PBExportHeader$u_ddlb_filter.sru
$PBExportComments$Drop down list box filter class
forward
global type u_ddlb_filter from dropdownlistbox
end type
end forward
...
global u_ddlb_filter u_ddlb_filter

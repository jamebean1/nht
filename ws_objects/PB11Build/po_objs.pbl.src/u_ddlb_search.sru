$PBExportHeader$u_ddlb_search.sru
$PBExportComments$Drop down list box search class
forward
global type u_ddlb_search from dropdownlistbox
end type
end forward
...
global u_ddlb_search u_ddlb_search

$PBExportHeader$u_em_filter.sru
$PBExportComments$Spin box filter class
forward
global type u_em_filter from editmask
end type
end forward
...
string DisplayData="1	1/2	2/3	3/"
double Increment=1
string MinMax="~~"
...
global u_em_filter u_em_filter

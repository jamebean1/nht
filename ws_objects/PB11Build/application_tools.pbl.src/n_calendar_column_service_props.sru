$PBExportHeader$n_calendar_column_service_props.sru
forward
global type n_calendar_column_service_props from nonvisualobject
end type
end forward
...
global n_calendar_column_service_props n_calendar_column_service_props
...
//	dw_control.Object.columnname.EditMask
	ls_editmask = idw_data.describe( ls_col + ".EditMask.Mask")
	
	ll_pos = Pos(ls_editmask, '##/##')
	
//	if (upper(left(idw_data.describe( ls_col + ".coltype"),4)) <> "DATE" Or ll_pos <= 0)  then Continue
...
on n_calendar_column_service_props.create
call super::create
TriggerEvent( this, "constructor" )
end on

on n_calendar_column_service_props.destroy

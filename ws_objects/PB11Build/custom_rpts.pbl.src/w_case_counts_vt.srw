$PBExportHeader$w_case_counts_vt.srw
$PBExportComments$Vermont Parameter window for Case Counts report
forward
global type w_case_counts_vt from w_response_std
end type
type dw_parameters from datawindow within w_case_counts_vt
end type
type cb_cancel from u_cb_close within w_case_counts_vt
end type
type cb_ok from u_cb_close within w_case_counts_vt
end type
type st_1 from statictext within w_case_counts_vt
end type
end forward
...
integer width = 1518
integer height = 1152
string title = "Case Counts Report Parameters"
...
global w_case_counts_vt w_case_counts_vt
...
//  09/10/02 C. Jackson  Add new drop downs
//  
//***********************************************************************************************
...
integer taborder = 10
string title = "none"
string dataobject = "d_case_counts_parms_vt"
...
IF dwo.name = 'all_except_fep' THEN
	...
	IF data = 'Y' THEN
	   ...
	   THIS.SetItem (1,'line_of_business', '' )
...
//  -------- ----------- -----------------------------------------------------------------------
//  05/14/01 C. Jackson  Original Version
//  12/10/01 C. Jackson  Correct Date Validation message
//  01/28/02 C. Jackson  Do not let the user query on a year prior to 1753.  It will fail on the
//                       database side. (SCR 2612)
//**********************************************************************************************

STRING l_cSubscriber, l_cLOB, l_cAllExceptFEP

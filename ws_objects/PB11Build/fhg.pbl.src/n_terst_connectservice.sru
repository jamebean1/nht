$PBExportHeader$n_terst_connectservice.sru
$PBExportComments$Generated Database Connection Service
forward
global type n_terst_connectservice from nonvisualobject
end type
end forward

global type n_terst_connectservice from nonvisualobject
end type
global n_terst_connectservice n_terst_connectservice
...
Choose Case is_connectfrom
	...
	Case IS_USE_INIFILE						/*  Populate Database Connection from INI file  */
		string ls_inifile = "C:\Users\Administrator\Desktop\SVN\netsolhost\pb11build\fhg.ini"
...
on n_terst_connectservice.create
call super::create
TriggerEvent( this, "constructor" )
end on

on n_terst_connectservice.destroy

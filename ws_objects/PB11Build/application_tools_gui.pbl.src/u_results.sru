...
forward
global type u_results from u_dynamic_gui
end type
type dw_matched_records from u_dw_gui within u_results
end type
type uo_titlebar from u_title_button_bar within u_results
end type
type st_separator from u_theme_strip within u_results
end type
end forward

$PBExportHeader$u_composite_report_horizontal_slider.sru
forward
global type u_composite_report_horizontal_slider from statictext
end type
end forward
...
global u_composite_report_horizontal_slider u_composite_report_horizontal_slider
...
public subroutine of_set_reference (powerobject ao_powerobject)
end prototypes
...
//		iu_reference.Event ue_notify('slider moved', This)
//	elseif isvalid( iw_reference) then
//		iw_reference.Dynamic Event ue_notify('slider moved', This)
//	end if
//end if
//
//If IsNumber(w_frame.Title) Then
...
//This will set this objects background to barcolor
...
public subroutine of_set_reference (powerobject ao_powerobject);If Not IsValid(ao_powerobject) Then Return

Choose Case ao_powerobject.TypeOf()
	Case Window!
		iw_reference = ao_powerobject
	Case Else
		iu_reference = ao_powerobject
End Choose

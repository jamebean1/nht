$PBExportHeader$u_deal_display_datawindow.sru
$PBExportComments$Basic DAO aware datawindow for deal capture. -  Done
forward
global type u_deal_display_datawindow from u_datawindow
end type
end forward
...
global u_deal_display_datawindow u_deal_display_datawindow
...
on u_deal_display_datawindow.create
call super::create
end on

on u_deal_display_datawindow.destroy
call super::destroy
end on
